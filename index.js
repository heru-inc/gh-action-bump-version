...
(async () => {
  ...
  try {
    ...
    const remoteRepo = `https://${process.env.CUSTOM_ACTOR ? process.env.CUSTOM_ACTOR : process.env.GITHUB_ACTOR}:${process.env.GITHUB_TOKEN}@github.com/${process.env.GITHUB_REPOSITORY}.git`;
